...
def patche():
    ...
    os.system('git push -f -o merge_request.create -o merge_request.target=$ORIGBRANCH -o merge_request.remove_source_branch -o merge_request.title="patche vulnerabilities" -o merge_request.description="patche vulnerabilities"')
